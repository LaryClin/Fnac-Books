                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group{{ $errors->has('adh_mel') ? ' has-error' : '' }}">
                            <label for="adh_mel" class="col-md-4 control-label">E-Mail Address</label>

                            <div class="col-md-6">
                                <input id="adh_mel" type="email" class="form-control" name="adh_mel" value="{{ old('adh_mel') }}" required autofocus>
